...
<templates:admin-template title="Edita Subcategoria">
<form:form class="form-horizontal" modelAttribute="subcategoryFormUpdate" method="post" action="${formAction}">
<div class="panel panel-default">
    <div class="panel-heading">
        <h1 class="panel-title">Atualização da Subcategoria</h1>
    </div>
        ...
        <div class="form-check">
            ...
            <div class="col-sm-2">
                <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1"
                       value="ACTIVE" ${subcategoryFormUpdate.status == 'ACTIVE' ? "checked" : ""} />
                ATIVA
            </div>
            <div>
                <input class="form-check-input" type="radio" name="status" id="flexRadioDefault2"
                       value="INACTIVE" ${subcategoryFormUpdate.status == 'INACTIVE' ? "checked" : ""} />
                INATIVA
            </div>
            <div class="form-check">
            </div>
